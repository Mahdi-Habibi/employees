...
# window menu
l1=tk.Label(win,text='Full Name:',font=font)
l1.place(x=fixedX,y=10)
en=tk.StringVar()
e1=tk.Entry(win,textvariable=en,font=font,width=20)
e1.place(x=fixedX,y=40)

l2=tk.Label(win,text='Age:',font=font)
l2.place(x=fixedX,y=70)
ea=tk.IntVar()
e2=tk.Entry(win,textvariable=ea,font=font,width=20)
e2.place(x=fixedX,y=100)

l3=tk.Label(win,text='Education Level:',font=font)
...
l4=tk.Label(win,text='Department:',font=font)
...
l5=tk.Label(win,text='Monthly Salary($):',font=font)
l5.place(x=fixedX,y=250)
es=tk.IntVar()
e5=tk.Entry(win,textvariable=es,font=font,width=20)
e5.place(x=fixedX,y=280)

l6=tk.Label(win,text='Position:',font=font)
...
# buttons
b1=tk.Button(win,text='New',font=font,width=10,command=new)
b1.place(x=fixedBtnX,y=20)
b2=tk.Button(win,text='Save',font=font,width=10,command=save)
b2.place(x=fixedBtnX,y=70)
b3=tk.Button(win,text='Display all',font=font,width=10,command=disAll)
b3.place(x=fixedBtnX,y=120)
b4=tk.Button(win,text='Close',font=font,width=10,command=win.destroy)
